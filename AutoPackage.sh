...
bundle_identifier="com.bozhi.SwiftMore"

#以下两个参数为蒲公英平台分配可以在账户这只里查看
#API Key
apiKey="d97fea76c41b9a91f82b2103448214dd"
#User Key
uKey="b1e436641da6933ff975fea4e064e548"
